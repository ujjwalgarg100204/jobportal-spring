...
/**
 * Utility class for generating and validating JWT tokens. This class provides methods for creating
 * JWT tokens based on user authentication information, extracting user email from a token, and
 * validating the integrity and expiration of a token.
 */
@Slf4j
@Component
public class JwtUtils {
  ...
  /**
   * Validates the given JWT token. Checks the token's integrity, expiration, and format.
   *
