 ...
 * This class represents the user details required for Spring Security
 * authentication and authorization.
 * It contains user information such as id, email, password, and authorities.
 */
@Builder
@Getter
public class UserDetailsImpl implements UserDetails {
     ...
     * Converts the user's roles to {@link GrantedAuthority}.
     *
